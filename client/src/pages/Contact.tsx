...
import { Phone, Mail, Send, Share } from "lucide-react";
import { 
  Form, 
  FormControl, 
  FormDescription, 
...
const Contact = () => {
  ...
  const whatsappUrl = `https://wa.me/972${contact.whatsapp.phone.substring(1)}?text=${encodedMessage}`;
              ...
              <div className="mt-6">
                ...
                <div className="bg-gray-50 p-6 rounded-lg">
                  ...
                  <div className="flex gap-3">
                    ...
                    <ShareButton className="min-w-24" variant="secondary" />
                  </div>
                </div>
              </div>
            </div>
